...
void Model::GenerateObjectBufferMesh(const char* mesh_name, const char* texture_name) {
	/*----------------------------------------------------------------------------
...
void Model::setup(const char* mesh_name, const char* texture_name, GLuint shader) {
	shaderProgramID = shader;
	GenerateObjectBufferMesh(mesh_name, texture_name);
}