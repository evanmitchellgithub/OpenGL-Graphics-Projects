...
GLuint Shader::CompileShaders(int num)
{
    ...
    if (num == 0) {
        AddShader(shaderProgramID, "Shaders\\TextureMapVertex.txt", GL_VERTEX_SHADER);
        AddShader(shaderProgramID, "Shaders\\TextureMapFragment.txt", GL_FRAGMENT_SHADER);
    }
    if (num == 2) {
    ...
    if (num == 3) {
        AddShader(shaderProgramID, "Shaders\\VertexShaderPhong2.txt", GL_VERTEX_SHADER);
        AddShader(shaderProgramID, "Shaders\\FragmentShaderPhong2.txt", GL_FRAGMENT_SHADER);
    }
    if (num == 4) {
        AddShader(shaderProgramID, "Shaders\\TextureMapVertex.txt", GL_VERTEX_SHADER);
        AddShader(shaderProgramID, "Shaders\\TextureMapFragment.txt", GL_FRAGMENT_SHADER);
